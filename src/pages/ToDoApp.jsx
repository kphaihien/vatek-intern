    ...
    <>
      <section className="bg-[#5DCBCE] w-full h-screen flex items-center justify-center ">
        <div className="flex flex-col justify-start gap-2 w-[40%] h-[60%] p-8 bg-white rounded-md">
          <div>
            <h1 className="text-3xl font-bold pb-2">{t('todo.title')}</h1>
            <div className="flex justify-between items-center gap-1">
              ...
              <button
                ...
                className="bg-purple-500  text-white w-10 h-10 rounded-md p-2 font-extrabold"
              >
                +
              </button>
            </div>
          ...
          <div className="flex flex-row justify-between items-center pt-2 text-sm">
            ...
            <button
              ...
              className="cursor-pointer text-white bg-purple-500 px-2 py-1 rounded-sm"
            >
